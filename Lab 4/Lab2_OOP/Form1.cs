...
namespace Lab4_OOP
{
    public partial class Form1 : Form
    {
        ...
        {
            if (!(item == 'M' || item == 'O' || item == 'D' || item == ';' || item == '[' || item == ']'))
            {
                return true;
            }
            else
            ...
            try
            {
                if (op.symbolOperator == 'O')
                {
                    if (operands.Count == 5)
                    {
                        ...
                        {
                            Robot figure = new Robot(name, x, y, w, h);
                            op = new Operator(figure.Draw_with_name, 'O');
                    ...
                    {
                        MessageBox.Show("Опертор O принимает 5 параматетров.");
                        log.Items.Add("Неверное число параметров для оператора O.");
                    }
                }
                else if (op.symbolOperator == 'M')
                {
                    ...
                    {
                        MessageBox.Show("Опертор M принимает 5 параматетров.");
